    ...
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so"  method="get" action="{{ url('admin/user')}}">
          ...
          <input type="text" name="username"  placeholder="请输入用户名" value="{{$request->input('username')}}" autocomplete="off" class="layui-input">
          <input type="email" name="email"  placeholder="请输入邮箱" value="{{$request->input('email')}}" autocomplete="off" class="layui-input">
      ...
      <table class="layui-table">
        ...
        @foreach($user as $v)
          <tr>
            ...
            <td class="td-manage">
              <a title="权限" href="{{ url('admin/user/auth/'.$v->user_id) }}">
